 ...
 * </p>
 * <ul>
 * <li>The {@link kpk.dev.CalendarGrid.util.CalendarContract.Calendars} table holds the calendar specific information. Each
 * row in this table contains the details for a single calendar, such as the
 * name, color, sync info, etc.</li>
 * <li>The {@link kpk.dev.CalendarGrid.util.CalendarContract.Events} table holds the event specific information. Each row
 ...
 * properties are stored on separate tables and reference the {@link kpk.dev.CalendarGrid.util.CalendarContract.Events#_ID}
 * to link them with the event.</li>
 * <li>The {@link kpk.dev.CalendarGrid.util.CalendarContract.Instances} table holds the start and end time for occurrences
 ...
 * <li>The {@link kpk.dev.CalendarGrid.util.CalendarContract.Attendees} table holds the event attendee or guest
 ...
 * <li>The {@link kpk.dev.CalendarGrid.util.CalendarContract.Reminders} table holds the alert/notification data. Each row
 ...
 * {@link kpk.dev.CalendarGrid.util.CalendarContract.Calendars#MAX_REMINDERS} which is set by the Sync Adapter that owns
 * the given calendar. Reminders are specified in minutes before the event and
 * have a type.</li>
 * <li>The {@link kpk.dev.CalendarGrid.util.CalendarContract.ExtendedProperties} table holds opaque data fields used by the
 ...
 * <ul>
 * <li>
 * {@link kpk.dev.CalendarGrid.util.CalendarContract.SyncState}, which contains free-form data maintained by the sync
 * adapters</li>
 * </ul>
 *
 */
...
//    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
     ...
     * specified in {@link kpk.dev.CalendarGrid.util.CalendarContract.EventsColumns#CUSTOM_APP_PACKAGE}. The custom app
     ...
     * {@link kpk.dev.CalendarGrid.util.CalendarContract.EventsColumns#CUSTOM_APP_URI}.
     * <p>
...
//    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    ...
    /**
     * Intent Extras key: {@link kpk.dev.CalendarGrid.util.CalendarContract.EventsColumns#CUSTOM_APP_URI} for the event in
     ...
     * {@link kpk.dev.CalendarGrid.util.CalendarContract.Calendars#ACCOUNT_NAME} and {@link kpk.dev.CalendarGrid.util.CalendarContract.Calendars#ACCOUNT_TYPE} as
     * query parameters.
     *
     ...
     *
     * @see kpk.dev.CalendarGrid.util.CalendarContract.SyncColumns#ACCOUNT_TYPE
     */
    ...
    protected interface SyncColumns extends CalendarSyncColumns {
         ...
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Events#LAST_SYNCED} set to 1 whenever the event
    ...
    protected interface CalendarColumns {
        ...
        /**
         * A key for looking up a color from the {@link kpk.dev.CalendarGrid.util.CalendarContract.Colors} table. NULL or
         ...
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Colors} table. @see Colors
         * <P>
         * Type: TEXT
         * </P>
         */
        ...
        */
         ...
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Reminders#METHOD_DEFAULT}, {@link kpk.dev.CalendarGrid.util.CalendarContract.Reminders#METHOD_ALERT},
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Reminders#METHOD_EMAIL}, {@link kpk.dev.CalendarGrid.util.CalendarContract.Reminders#METHOD_SMS},
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Reminders#METHOD_ALARM}. Column name.
         * <P>Type: TEXT</P>
         */
         ...
         * calendar in the format "#,#,#". Valid types are
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Events#AVAILABILITY_BUSY}, {@link kpk.dev.CalendarGrid.util.CalendarContract.Events#AVAILABILITY_FREE},
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Events#AVAILABILITY_TENTATIVE}. Setting this field to only
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Events#AVAILABILITY_BUSY} should be used to indicate that
         ...
         * in the format "#,#,#". Valid types are {@link kpk.dev.CalendarGrid.util.CalendarContract.Attendees#TYPE_NONE},
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Attendees#TYPE_OPTIONAL}, {@link kpk.dev.CalendarGrid.util.CalendarContract.Attendees#TYPE_REQUIRED},
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Attendees#TYPE_RESOURCE}. Setting this field to only
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Attendees#TYPE_NONE} should be used to indicate that changing
...
//        }
    ...
    protected interface EventsColumns {
        ...
        /**
         * The {@link kpk.dev.CalendarGrid.util.CalendarContract.Calendars#_ID} of the calendar the event belongs to.
         * Column name.
         * <P>Type: INTEGER</P>
         */
         ...
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Calendars#CALENDAR_COLOR}.
         * Read-only value. To modify, write to {@link #EVENT_COLOR} or
         * {@link kpk.dev.CalendarGrid.util.CalendarContract.Calendars#CALENDAR_COLOR} directly.
         *<P>
         *     Type: INTEGER
         *</P>
         */
         ...
         * event is on a calendar with {@link kpk.dev.CalendarGrid.util.CalendarContract.Calendars#CAN_PARTIALLY_UPDATE} set to 1. This copy
        ...
        /**
         * The {@link kpk.dev.CalendarGrid.util.CalendarContract.Events#_ID} of the original recurring event for which this
         ...
         * {@link kpk.dev.CalendarGrid.util.CalendarContract#ACTION_HANDLE_CUSTOM_EVENT} for details.
         * Column name.
         * <P> Type: TEXT </P>
         */
...
//        }
     ...
     * <dt><b>Update</b></dt>
     * <dd>To perform an update of an Event the {@link kpk.dev.CalendarGrid.util.CalendarContract.Events#_ID} of the event
     * should be provided either as an appended id to the Uri (
     * {@link android.content.ContentUris#withAppendedId}) or as the first selection item--the
     * selection should start with "_id=?" and the first selectionArg should be
     ...
     * <dt><b>Delete</b></dt>
     * <dd>Events can be deleted either by the {@link kpk.dev.CalendarGrid.util.CalendarContract.Events#_ID} as an appended
     ...
     * or at most a single row if the {@link kpk.dev.CalendarGrid.util.CalendarContract.Events#_ID} is appended to the Uri.
    ...
    protected interface CalendarCacheColumns {
        /**
         * The key for the setting. Keys are defined in {@link kpk.dev.CalendarGrid.util.CalendarContract.CalendarCache}.
         */
     ...
     * have been removed from the {@link kpk.dev.CalendarGrid.util.CalendarContract.Calendars} or {@link kpk.dev.CalendarGrid.util.CalendarContract.Events} tables.
     */
